                        ...
                        () => Container(
                          ...
                          child: Center(
                            child: timeController.times[index] == "+"
                                ...
                                : CircleAvatar(
                                    radius: 20,
                                    backgroundColor: timeController
                                                    .time1.value ==
                                                timeController.times[index] ||
                                            timeController.time2.value ==
                                                timeController.times[index]
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Obx(
                                          () => Text(
                                              "${timeController.hTask.value.startTime ?? "-"}-${timeController.hTask.value.endTime ?? "00:00"}",
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      CircleAvatar(
                                        ...
                                        child: timeController
                                                    .hTask.value.priority ==
                                                "Low"
                                            ? const Icon(
                                                Icons.check,
                                                size: 14,
                      ...
                      child: SizedBox(
                        ...
                        child: Stack(
                          children: [
                            ...
                            const Padding(
                              padding: EdgeInsets.only(left: 25, top: 15, right: 8),
                              child: Center(
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
